...
export function ShareDialog({ open, onOpenChange, json }: ShareDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md overflow-hidden p-4">
        <DialogHeader>
        ...
        {tooLong ? (
          <div className="flex flex-col gap-3">
            <div className="rounded-lg border border-destructive/30 bg-destructive/10 px-3 py-2 text-sm text-destructive">
              JSON exceeds URL length limit (~2KB compressed). Download it as a
              file instead.
            </div>
          ...
          <div className="flex flex-col gap-3">
            <div className="rounded-lg border border-border bg-muted/50 px-3 py-2 overflow-x-auto">
